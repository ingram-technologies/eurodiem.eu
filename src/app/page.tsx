      ...
      <section className="home-section home-gap" id="about">
        <div className="home-container">
          ...
          <p className="home-gap__statement">
            <span className="home-mark home-mark--yellow">Europe</span> faces a
            significant and growing protection gap across various risk
            categories, with estimated annual uninsured losses of{" "}
            <span className="home-mark home-mark--blue">€200 billion</span> that
            could be covered by the private market.
          </p>
        ...
        <div className="home-container">
          ...
          <div className="home-syndication">
            <div className="home-syndication__copy">
              <h3>Risk Syndication Made Simple and How to Industrialize it</h3>
              <p>
                Rather than finding one carrier matching 100% of the capacity,
                let&rsquo;s find more easily multiple carriers to share the
                capacity thanks to EuroDIEM.
              </p>
              <p>
                Creating a syndication platform will allow undertaking smaller
                and more numerous risk portions, creating a wider pool at scale,
                attracting more carriers/investors to access the insurance risk
                transfer market with a lower cost of capital.
              </p>
            ...
            <div className="home-diagram-card" aria-label="Syndication comparison">
              <h3>Traditional Approach</h3>
              <div className="home-diagram-row home-diagram-row--top">
                <MiniRiskNode>Risk Transferor<br />100%</MiniRiskNode>
                <span aria-hidden="true">→</span>
                <MiniRiskNode>Single Carrier<br />100%</MiniRiskNode>
              </div>
              <p className="home-diagram-card__label">EuroDIEM</p>
              <span className="home-diagram-card__down" aria-hidden="true">
                ↓
              </span>
        ...
        <div className="home-container home-participants__grid">
          <div className="home-participants__legend">
            ...
            <div className="home-participant-type">
              <span className="home-dot home-dot--yellow" aria-hidden="true" />
              <div>
                <h3>Insurance companies</h3>
                <p>
                  Insurance companies already underwriting such risks, but also
                  new entrants such as local mutuals and bancassurers now able
                  to test these new waters both on the B2B and B2B+ market with
                  small exposures (%).
                </p>
              </div>
            </div>
            <div className="home-participant-type">
              <span className="home-dot home-dot--blue" aria-hidden="true" />
              <div>
                <h3>Risk Transferors</h3>
                <p>
                  SMEs, corporates, sponsors, and cedants seeking to transfer
                  risk through the EuroDIEM platform.
                </p>
              </div>
            </div>
            <div className="home-participant-type">
              <span className="home-dot home-dot--red" aria-hidden="true" />
              <div>
                <h3>Other non-Insurance companies</h3>
                <p>
                  Other non insurance investors: private equity, pension funds,
                  family offices.
                </p>
              </div>
            </div>
          ...
          <div className="home-participants__diagrams">
            <article>
              ...
              />
              <p>
                Matching the customer (SME/corporate) risks with insurance
            ...
            <article>
              ...
              />
              <p>
                Matching sponsors/cedants risks with investors risk appetite
                (of which (re) insurance carriers)
              </p>
            </article>
          ...
          <div className="home-data__grid">
            ...
            <article>
              ...
              <p>
                ...
                ECB/EIOPA joint report proposal, expending though to risks
                beyond nat cat property risks.
              </p>
            </article>
          </div>
        </div>
      ...
      <section className="newsletter" id="newsletter">
        <div className="newsletter__inner">
          <div className="newsletter__copy">
            ...
            <p className="newsletter__lead">Stay informed about our progress.</p>
