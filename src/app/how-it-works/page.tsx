    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="section__lead">
            Bringing significant geographical capital diversification and risk
            mutualization.
          </p>
          ...
          <div className="split split--2">
            ...
            <div className="panel">
              <h3 className="panel__title">B2B+: Securitization Platform</h3>
              <p style={{ margin: 0, color: "var(--color-muted)" }}>
                Connects sponsors/cedants risks with a diversified pool of
                investors of which (re)insurance carriers, enabling more
                efficient net transfer and coverage.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section section--pale">
        <div className="container">
          ...
          <p className="section__lead">
            The level of matchmaking will be more or less partial depending on
            the level of complexity and standardization of the risks presented.
          </p>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="section__lead">
            Our platform facilitates a structured process to match risks with
          ...
          <div className="steps">
            <article className="step">
              ...
              <ul className="tier__list" style={{ marginTop: 4 }}>
                <li>
                  Insurance carriers upload and update their risk appetite on
                  the platform
                </li>
                <li>
                  Risk transferors upload a standardized description of the
                  risk
                </li>
                <li>
                  The platform performs initial matching between risks and
                  carrier appetites
                </li>
              </ul>
            </article>
            <article className="step">
              ...
              <ul className="tier__list" style={{ marginTop: 4 }}>
                <li>
                  Pre-selected carriers decide whether to participate in the
                  syndication
                </li>
                <li>For Tier 1 risks, an algorithm leads to optimal subscription</li>
                <li>
                  For Tier 2 &amp; 3, brokers help refine the structure after
                  NDAs are signed
                </li>
              </ul>
            </article>
            <article className="step">
              ...
              <ul className="tier__list" style={{ marginTop: 4 }}>
                ...
                <li>
                  Messages related to premium, commission, and claims are
                  processed
                </li>
                <li>
          ...
          <div className="split split--2">
            <div className="panel">
              ...
              <p style={{ margin: "0 0 16px", color: "var(--color-muted)" }}>
                ...
                the platform and an additional factor of price reduction
                boosting demand.
              </p>
            ...
            <div className="panel">
              ...
              <p style={{ margin: "0 0 16px", color: "var(--color-muted)" }}>
                ...
                (supra)national debt, while still keeping PPPs at a higher
